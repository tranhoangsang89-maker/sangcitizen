  ...
  const cases = [
    {
      ...
      links: [
        { url: "https://cty-solar24h.tranhoangsang89.workers.dev/", text: "🔗 Xem Hệ Sinh Thái Live" }
      ]
    },
    {
      ...
      links: [
        { url: "https://tramsac-thanh-nhan.vercel.app/", text: "⚡ Trải Nghiệm App Trạm Sạc" }
      ]
    },
    {
      ...
      links: [
        { url: "https://sagi-ai.vercel.app/", text: "🤖 Trò Chuyện Cùng Sagi" }
      ]
    },
    {
      title: "Landing Page Dịch Vụ Xe",
      client: "Tài Travel & LMN Express",
      tag: "Vận Tải & Du Lịch",
      desc: "Thiết kế Landing Page chuẩn SEO, tích hợp nút đặt xe & gọi Zalo 1-chạm, tối ưu di động, bàn giao thần tốc trong 48 giờ.",
      img: "/images/case-transport.jpg",
      links: [
        { url: "https://taitravel.onrender.com/", text: "🚗 Xem Tài Travel" },
        { url: "https://lmn-express.onrender.com/", text: "🚐 Xem LMN Express" }
      ]
    }
  ];
            ...
            <div key={idx} className="group hover:border-slate-700 shadow-xl overflow-hidden rounded-2xl bg-slate-900/90 border border-slate-800 flex flex-col justify-between transition-colors">
              <div>
                ...
                <div className="p-6 pb-2">
                  <p className="text-[#0055D4] font-semibold text-sm mb-1">
                    {item.tag ? `${item.tag} • ${item.client}` : item.client}
                  </p>
